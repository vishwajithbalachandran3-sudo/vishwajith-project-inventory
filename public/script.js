...
(function(){
  ...
  const notify=document.querySelector('.icon-btn');if(notify)notify.onclick=()=>{const expected=orders.find(order=>order[0]==='PO-2048')?.[3]||formatOrderDate(4);showDialog('Notifications',`<p>🔴 8 products are critically low.</p><p>📦 PO-2048 is expected on ${expected}.</p><p>⚠ Siemens Proximity Sensor is unavailable for upcoming maintenance.</p>`)};
